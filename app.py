...
MPH_PUMPS = [
    {
        ...
        "GVF_max": 0.90,
        "MPH_Curves": {
            # Werte passen exakt zum Screenshot image_b03c8c.png
            "GVF_5_Percent": {
                "p": [0, 2, 4, 6, 8, 10, 12, 14],
                "H_sim": [0, 28, 50, 72, 85, 90, 85, 75]
            },
            "GVF_15_Percent": {
                "p": [0, 2, 4, 6, 8, 10, 12, 14],
                "H_sim": [0, 24, 48, 68, 78, 82, 75, 60]
            },
            "GVF_25_Percent": {
                "p": [0, 2, 4, 6, 8, 10, 12, 14],
    ...
    },
    {
        ...
        "GVF_max": 0.95,
        "MPH_Curves": {
            # Skalierung ca. 1.4x von MPH-50
            "GVF_5_Percent": {
                "p": [0, 2, 4, 6, 8, 10, 12, 14],
                "H_sim": [0, 38, 70, 100, 120, 125, 120, 105]
            },
            "GVF_15_Percent": {
                "p": [0, 2, 4, 6, 8, 10, 12, 14],
                "H_sim": [0, 34, 65, 95, 110, 114, 105, 85]
            },
            "GVF_25_Percent": {
                "p": [0, 2, 4, 6, 8, 10, 12, 14],
                "H_sim": [0, 28, 56, 82, 92, 88, 68, 35]
            }
        }
    },
    {
        ...
        "GVF_max": 0.85,
        "MPH_Curves": {
            # Skalierung ca. 1.8x von MPH-50 (Bleibt unter 180 l/min)
            "GVF_5_Percent": {
                "p": [0, 2, 4, 6, 8, 10, 12, 14],
                "H_sim": [0, 50, 90, 130, 155, 162, 155, 135]
            },
            "GVF_15_Percent": {
                "p": [0, 2, 4, 6, 8, 10, 12, 14],
                "H_sim": [0, 43, 85, 122, 140, 148, 135, 110]
            },
            "GVF_25_Percent": {
                "p": [0, 2, 4, 6, 8, 10, 12, 14],
                "H_sim": [0, 36, 72, 105, 118, 112, 86, 45]
            }
        }
    }
]
